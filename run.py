...
def parse_arguments():
    ...
    parser.add_argument("--data_path", default='/home/sharing/disk1/data', type=str, help="The input data dir. Should contain text, video and audio data for the task.")
    ...
    parser.add_argument('--enhance_llm_feats_path', type=str, default='pro_MIntRec_reason_all.pkl', help="The directory of the enhacne_llm features.")
    ...
    parser.add_argument("--bert_base_uncased_path", type=str, default="/home/sharing/disk1/bert-base-uncased", help="The name of the pre-trained BERT model to use.")  #
...
def run(args, debug_args=None):
    ...
    if args.method.startswith('text'):
        method = method_manager(args, data)
    
    # elif args.method.startswith('gobi'):
    #     # 预训练
    #     method = method_manager(args, data)
