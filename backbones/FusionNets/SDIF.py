...
class SDIF(nn.Module):
    def __init__(self, args):
        ...
        self.fusion.add_module('fusion_layer_1', nn.Linear(in_features=self.dst_feature_dims * 7, out_features=self.dst_feature_dims * 3))
    ...
    def forward(self, text_feats, video_feats, audio_feats,enhance_feats):
        ...
        # print("=======deep_rep的维度为：=====",deep_rep.shape)#======deep_rep的维度为：===== torch.Size([16, 4608]) 9_30


        enhance_llm= self.enhance_models(enhance_feats)
        all_pooled = enhance_llm['all_layer_pooled']  # list of (16, 768)
        X_enhanced = self.progressive_enhancer(deep_rep, all_pooled)
