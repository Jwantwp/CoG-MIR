...
class MMIM(nn.Module):
    ...
    def __init__(self, args):
        ...
        dim_sum = args.d_aout + args.d_vout + args.d_tout+ args.enhance_dst_feature_dims
    ...
    def forward(self, text_feats, video_data, audio_data,enhance_feats,mode = None, binary_inputs = None, feature_ext = False):
        """
        ...
        fusion_tensor=torch.cat([text_h, audio_h, vision_h], dim=1)
        
        enhance_llm= self.enhance_models(enhance_feats)
        all_pooled = enhance_llm['all_layer_pooled']  # list of (16, 768)
        
        
        X_enhanced = self.progressive_enhancer(fusion_tensor, all_pooled)
        ...
        fusion, preds = self.fusion_prj(X_enhanced, binary_inputs = binary_inputs)

        preds = preds+enhance_logits
        
        # print("======fusion的维度为：=======",fusion.shape)    #======fusion的维度为：======= torch.Size([16, 512])9_30
