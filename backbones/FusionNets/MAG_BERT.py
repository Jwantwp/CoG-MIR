...
class MAG(nn.Module):
    ...
    def forward(self, text_embedding, visual, acoustic):
        ...
        # print("=======================+++++++==========",acoustic_vis_embedding.shape)
...
class MAG_BertModel(BertPreTrainedModel):
    ...
    Return:
        ...
        # Step 1: 扩展 attention_mask 到 (16, 37)
        ...
        # print("================",fused_embedding.shape)#torch.Size([16, 36, 768])9_30
...
class MAG_BertForSequenceClassification(BertPreTrainedModel):
    ...
    Returns:
        ...
        outputs,enhance_logits= self.bert(
            input_ids,
            visual,
            acoustic,
            enhance_feats,
...
class MAG_BERT(nn.Module):
    ...
    def forward(self, text_feats, video_feats, audio_feats,enhance_feats):
        ...
        outputs,enhance_logits = self.model(text = text_feats, visual = video_feats,acoustic = audio_feats,enhance_feats = enhance_feats)
        
        enhance_model_logits = outputs[0]
        
        return enhance_model_logits+enhance_logits    
