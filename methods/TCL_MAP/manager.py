    ...
    def _train(self, args): 
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(self.train_dataloader, desc="Iteration")):
                ...
                enhance_llm_feats = batch['enhance_llm_feats'].to(self.device)  # [16,480,768]
                label_ids = batch['label_ids'].to(self.device)  # [16]
                
                with torch.set_grad_enabled(True):

                    logits, _, condition, cons_condition = self.model(text_feats, video_feats, audio_feats, enhance_llm_feats,cons_text_feats, condition_idx)  # [16,20] [16,768] [16,768]  [16,768]
    ...
    def _get_outputs(self, args, dataloader, show_results = False):
        ...
        for batch in tqdm(dataloader, desc="Iteration"):
            ...
            with torch.set_grad_enabled(False):
                ...
                logits, features, condition, cons_condition = self.model(text_feats, video_feats, audio_feats,enhance_llm_feats, cons_text_feats, condition_idx)
