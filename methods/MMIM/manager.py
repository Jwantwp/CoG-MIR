    ...
    def _train_mmilb(self, args):
        ...
        with tqdm(self.train_dataloader) as td:
            ...
            for batch in td:
                ...
                results = self.model(text_feats, video_data, audio_data, enhance_llm_feats,mode = 'train')
    ...
    def _get_outputs(self, args, dataloader, show_results = False):
        ...
        for batch in tqdm(dataloader, desc="Iteration"):
            ...
            with torch.set_grad_enabled(False):
                ...
                logits, features = self.model(text_feats, video_data, audio_data,enhance_llm_feats)
